...
На скриншоте видно, что сообщения, отправленные Producer, успешно доставляются Consumer. Сообщения с корректными данными отображаются как VALID, сообщения с нарушениями правил валидации — как NOT VALID.
